...
public class SignUp extends AppCompatActivity implements View.OnClickListener{
    ...
    private void registerUser(){
        ...
        if(!email.contains("@") || !email.contains(".com")) {
            Toast.makeText(this,"Pogrešna forma email-a",Toast.LENGTH_LONG).show();
            return;
        }

        if (password.length() < 6) {
            Toast.makeText(this,"Lozinka mora imati najmanje 6 karaktera",Toast.LENGTH_LONG).show();
            return;
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(SignUp.this,"Registacija neuspešna",Toast.LENGTH_LONG).show();
                        }
